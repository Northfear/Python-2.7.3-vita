...
MODOBJS=          Modules/signalmodule.o  Modules/errnomodule.o  Modules/pwdmodule.o  Modules/_sre.o  Modules/_codecsmodule.o  Modules/_weakref.o  Modules/zipimport.o  Modules/symtablemodule.o  Modules/xxsubtype.o
...
# Compiler options
OPT=		-DNDEBUG -g -fwrapv -O3 -Wall -Wstrict-prototypes -mcpu=cortex-a9 -mfloat-abi=hard -DVITA
BASECFLAGS=	 -fno-strict-aliasing
CFLAGS=		$(BASECFLAGS) -g -O2 $(OPT) $(EXTRA_CFLAGS)
# Both CPPFLAGS and LDFLAGS need to contain the shell's value for setup.py to
# be able to build extension modules using the directories specified in the
# environment variables
CPPFLAGS=	-I. -IInclude -I$(srcdir)/Include -static
...
CONFIG_ARGS=	 '--disable-ipv6' '--without-threads' '--build=x86_64-linux-gnu' '--host=arm-vita-eabi' 'LDFLAGS=-static -static-libgcc' 'CPPFLAGS=-static' 'CONFIG_SITE=config.site' 'build_alias=x86_64-linux-gnu' 'host_alias=arm-vita-eabi'
...
MACHDEP_OBJS=	
LIBOBJDIR=	Python/
LIBOBJS=	 ${LIBOBJDIR}dup2$U.o ${LIBOBJDIR}getcwd$U.o
